...
# env: GITHUB_TOKEN, KSUN_MANAGER_ARTIFACT_ID, RESUKI_MANAGER_ARTIFACT_ID, KSUN_VERSION, RESUKI_VERSION
set -e
...
_fetch "ReSukiSU/ReSukiSU"   "${RESUKI_MANAGER_ARTIFACT_ID:-}" "ReSukiSU-manager-${RESUKI_VERSION:-ci}"
